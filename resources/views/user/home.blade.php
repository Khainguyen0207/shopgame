    ...
    <section class="menu special-menu">
        <div class="container">
            ...
            <div class="transaction__list">
                <a href="https://www.facebook.com/ntkhai2005" class="transaction__item">
                    <div class="transaction__icon">
                        <img src="{{ asset('assets/images/fb.jpg') }}" alt="Tài khoản" class="transaction__img"/>
                    </div>
                    <p class="text text__transaction__item">FB CHỦ SHOP </p>
                </a>
                <a href="{{ route('profile.deposit-atm') }}" class="transaction__item">
                    <div class="transaction__icon">
                        <img src="{{ asset('assets/images/napthe.png') }}" alt="Nạp thẻ" class="transaction__img"/>
                    </div>
                    <p class="text text__transaction__item">NẠP THẺ</p>
                </a>
                <a href="{{ route('profile.index') }}" class="transaction__item">
                    <div class="transaction__icon">
                        <img src="{{ asset('assets/images/profile.jpg') }}" alt="Dịch vụ" class="transaction__img"/>
                    </div>
                        ...
                        @if ($category->active)
                            <a href="{{ route('random.index', ['slug' => $category->slug]) }}" class="category__item">
                                ...
                                <span class="badge">{{ number_format($category->allAccount) }} Tài
                                    khoản</span>
                                    <span class="badge">Đã bán: 200</span>
                                </div>
