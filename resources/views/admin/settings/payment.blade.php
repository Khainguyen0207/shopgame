        ...
        <div class="content">
            ...
            <div class="card-body">
                <div class="alert alert-notication-custom alert-dismissible fade show" role="alert">
                    <a href="https://gachthenhanh.com" target="_blank">GACHTHENHANH.COM</a>,
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="partner_website_card"
                                        ...
                                        <option value="gachthenhanh.vn"
                                            {{ $configs['partner_website_card'] === 'gachthenhanh.vn' ? 'selected' : '' }}>
                                            GACHTHENHANH.VN</option>
                                        <option value="gachthe1s.com"
                                                {{ $configs['partner_website_card'] === 'gachthe1s.com' ? 'selected' : '' }}>
                                            GACHTHE1S.COM</option>
                                    </select>
